    ...
    class BNode:
        ...
        def insert_nonfull(self, x):
            ...
            # B-Node is internal node
                ...
                j = b_search(self.keys, 0, self.num_keys, x)
                j = j if (self.keys[j] > x) else j + 1
        ...
        def delete(self, x):
            ...
            # x not found in this node
                ...
                pos = pos if (self.keys[pos] > x) else pos + 1
        ...
        if (self.root is None):
            ...
            if (self.root.is_full()):
                ...
                if (new_root.keys[0] > x):
                    new_root.children[0].insert_nonfull(x)
                else:
                    new_root.children[1].insert_nonfull(x)
            else:
